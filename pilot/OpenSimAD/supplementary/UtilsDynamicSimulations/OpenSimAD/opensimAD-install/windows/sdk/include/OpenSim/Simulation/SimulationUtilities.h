...
namespace OpenSim {
	...
	/// The array returns the order of the states of an OpenSim model in the
	/// order of the underlying Simbody system.
	/// Helper function created by Antoine Falisse.
	OSIMSIMULATION_API SimTK::Array_<int> getIndicesOpenSimInSimbody(const Model& model);

	/// The array returns the order of the states of the SImbody system in the
	/// order of the OpenSim model.
	/// Helper function created by Antoine Falisse.
	OSIMSIMULATION_API SimTK::Array_<int> getIndicesSimbodyInOpenSim(const Model& model);
