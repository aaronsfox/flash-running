...
{ return setRotationFromAngleAboutX(NTraits<RealP>::cos(angle), NTraits<RealP>::sin(angle) ); }
...
{ setRotationFromAngleAboutY(NTraits<RealP>::cos(angle), NTraits<RealP>::sin(angle) ); }

/** Set this Rotation_ object to a right-handed rotation by an angle (in 
radians) about the Y-axis. **/
Rotation_&  setRotationFromAngleAboutY( RealP angle )  
{ return setRotationFromAngleAboutY(NTraits<RealP>::cos(angle), NTraits<RealP>::sin(angle) ); }
...
{ setRotationFromAngleAboutZ(NTraits<RealP>::cos(angle), NTraits<RealP>::sin(angle) ); }

/** Set this Rotation_ object to a right-handed rotation by an angle (in 
radians) about the Z-axis. **/
Rotation_&  setRotationFromAngleAboutZ( RealP angle )  
{ return setRotationFromAngleAboutZ(NTraits<RealP>::cos(angle), NTraits<RealP>::sin(angle) ); }
