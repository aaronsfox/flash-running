...
# %% Settings.
def run_tracking(baseDir, dataDir, subject, settings, case='0', model_full_name = None,
    ...
    # control problem.
    polynomial_bounds = {
            'hip_flexion_l': {'max': 120, 'min': -45},
            'hip_flexion_r': {'max': 120, 'min': -45},
            ...
            'knee_angle_l': {'max': 150, 'min': 0},
            'knee_angle_r': {'max': 150, 'min': 0},
