...
function [startTime, endTime] = getFullGaitCycleRight(grfFile)
    ...
    % data is structured, but could easily be edited (e.g. for getting a
    % half gait cycle, or left to left foot strike etc.)
    %
    ...
    rightStopInd = rightGrfOnInd(2) - 1;
    ...
    endTime = grfTable.getIndependentColumn().get(rightStopInd).doubleValue();
