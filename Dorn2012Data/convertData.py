...
#Get markers
dynamicData = dynamicC3DFile.read('JA1Gait21.c3d')
dynamicMarkers = dynamicC3DFile.getMarkersTable(dynamicData)
...
#Write static data to file
dynamicTRCFile.write(dynamicMarkers, 'jog.trc')

#Convert c3d force data to .mot and .xml files

#Load in the c3d data via btk
dynamicC3D = btk.btkAcquisitionFileReader()
dynamicC3D.SetFilename('JA1Gait21.c3d')
dynamicC3D.Update()
dynamicAcq = dynamicC3D.GetOutput()
...
#have which contacts
#Right foot = fp2,fp5
#Left foot = fp1,fp4,fp7
#Right forces
ground_force_r_vx = df_forces['Fx2'].values + df_forces['Fx5'].values
ground_force_r_vy = df_forces['Fy2'].values + df_forces['Fy5'].values
ground_force_r_vz = df_forces['Fz2'].values + df_forces['Fz5'].values
#Left forces
ground_force_l_vx = df_forces['Fx1'].values + df_forces['Fx4'].values + df_forces['Fx7'].values
ground_force_l_vy = df_forces['Fx1'].values + df_forces['Fy4'].values + df_forces['Fy7'].values
ground_force_l_vz = df_forces['Fx1'].values + df_forces['Fz4'].values + df_forces['Fz7'].values
#Right torques
ground_torque_r_x = df_forces['Mx2'].values + df_forces['Mx5'].values
ground_torque_r_y = df_forces['My2'].values + df_forces['My5'].values
ground_torque_r_z = df_forces['Mz2'].values + df_forces['Mz5'].values
#Left torques
ground_torque_l_x = df_forces['Fx1'].values + df_forces['Mx4'].values + df_forces['Mx7'].values
ground_torque_l_y = df_forces['Fx1'].values + df_forces['My4'].values + df_forces['My7'].values
ground_torque_l_z = df_forces['Fx1'].values + df_forces['Mz4'].values + df_forces['Mz7'].values
#Right position
ground_force_r_px = df_forces['Px2'].values + df_forces['Px5'].values
ground_force_r_py = df_forces['Py2'].values + df_forces['Py5'].values
ground_force_r_pz = df_forces['Pz2'].values + df_forces['Pz5'].values
#Left position
ground_force_l_px = df_forces['Fx1'].values + df_forces['Px4'].values + df_forces['Px7'].values
ground_force_l_py = df_forces['Fx1'].values + df_forces['Py4'].values + df_forces['Py7'].values
ground_force_l_pz = df_forces['Fx1'].values + df_forces['Pz4'].values + df_forces['Pz7'].values
...
forcesStorage.setName('grf')
#Print to file
forcesStorage.printResult(forcesStorage, 'jog_grf', os.getcwd(), 0.001, '.mot')
...
forceXML.cloneAndAppend(leftGRF)
#Set GRF datafile
forceXML.setDataFileName('jog_grf.mot')
#Set filtering for kinematics
forceXML.setLowpassCutoffFrequencyForLoadKinematics(12)
#Write to file
forceXML.printToXML('jog_grf.xml')
